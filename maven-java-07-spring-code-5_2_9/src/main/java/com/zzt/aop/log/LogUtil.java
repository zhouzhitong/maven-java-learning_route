...
public class LogUtil {
    ...
    //    @Pointcut("execution(public Integer com.zzt.aop.service.*.*(Integer,Integer))")
    @Pointcut("!execution(public Integer com.zzt.aop.service.MyCalculator.*(Integer,Integer)) ")
